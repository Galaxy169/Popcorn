...
function TextExpander({ expanded = false, className = "", collapsedNumWords = 25, expandButtonText = "Show More", collapseButtonText = "Show Less", buttonColor = "green", children }) {
  ...
  return (
    <div className={className}>
      <span>{isOpen ? children : children.split(" ").slice(0, collapsedNumWords).join(" ") + "..."}</span>
      <button style={{ color: buttonColor }} onClick={handleExpend}>
